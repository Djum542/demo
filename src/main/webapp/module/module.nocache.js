...
function gwtproject(){
    ...
    function getCompiledCodeFilename(){
      ...
      var strongName;
      try {
        unflattenKeylistIntoAnswers(['ie10'], '3E27F7D6A8D63992485B145295FE1B97');
        unflattenKeylistIntoAnswers(['gecko1_8'], 'A6D17A75A2B7AD7CE5C15FBECAEB9A8F');
        unflattenKeylistIntoAnswers(['ie9'], 'BE902CAE105A210C73A180748467A031');
        unflattenKeylistIntoAnswers(['ie8'], 'C594726F702D9BF6723A18EECDB381D2');
        unflattenKeylistIntoAnswers(['safari'], 'CBA00E3BF386CD64C8D6CB290ECDCAEA');
